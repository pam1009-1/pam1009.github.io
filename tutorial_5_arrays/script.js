...
document.addEventListener('DOMContentLoaded', function() {
    ...
    findButton.addEventListener('click', function() {
        ...
        foundItem.innerHTML = ''; // Clear area first
        if (bestRestaurant) {
            foundItem.innerHTML = `
                <div class="found-restaurant">
                    <p class="restaurant-name">${bestRestaurant.name}</p>
                    <p class="restaurant-cuisine">${bestRestaurant.cuisine}</p>
                    <p class="restaurant-rating">⭐ ${bestRestaurant.rating}</p>
                </div>
            `;
        } else {
